...
from src.datascience.entity.config_entity import (DataIngestionconfig, DataValidationconfig,DataTransformationConfig,DataTrainerConfig,ModelEvaluationConfig)
